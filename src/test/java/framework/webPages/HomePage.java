...
public class HomePage extends BasePage{
	...
	private By mobileNumberOrEmailField = By.xpath("//input[contains(text(),'Mobile number or email')]");
	private By reEnterEmail = By.xpath("//input[contains(text(),'Re-enter email')]");
	...
	private By expectedText = By.xpath("//div[contains(text(),'Please enter a valid mobile number or email address.')]");
	...
	public void reEnterEmail(String email) {
		setValue(reEnterEmail, email);
	}
	public WebElement getEmailWarningButton() {
		return SharedSD.getDriver().findElement(new ByChained(By.id("u_0_i"), By.className("_5dbc")));
	}
	public WebElement getErrorMessageByText(String expectedText){
		return SharedSD.getDriver().findElement(By.xpath("//*[text()[contains(.,'" + expectedText + "')]]"));
	}
